defmodule Server.ReactionTest do
  use Server.DataCase
  ...
  describe "like_photo" do
    ...
    test "list_like_photo/0 returns all like_photo" do
      like_photo = like_photo_fixture()
      assert Reaction.list_like_photo() == [like_photo]
    end
    ...
    test "update_like_photo/2 with valid data updates the like_photo" do
      like_photo = like_photo_fixture()
      assert {:ok, %LikePhoto{} = like_photo} = Reaction.update_like_photo(like_photo, @update_attrs)
    end
